...
<!--============================= 검색 조건 추가하기 끝     ============================= -->
				...
				if (e.keyCode == 13){
					...
					$("#dg_zipcode").datagrid({
					   ...
					   ,onSelect:function(index,row){//여기서 말하는 로우는 사용자가 선택한 로우의 정보를 가지고 있다.
 					   ...
 					   ,onDblClickCell:function(index,field,value){//선택한 셀의 값을 가져온다.
	...
	<!-- =========================== 사원 등록 끝   =================================== -->
	<!-- =========================== 사원 수정 시작 =================================== -->
	<div id="dlg_upd" data-options="closed:true" class="easyui-dialog" style="width:100%; max-width:480px; padding:30px 60px">
		<form id="f_upd">
		수정
		</form>	
	</div>
